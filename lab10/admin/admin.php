...
class AdminPanel {
    ...
    public function ZarzadzajKategoriami() {
        $zarzadzajKategoriami = new ZarzadzajKategoriami($this->conn);
            ...
            if (isset($_POST['action'])) {
                switch ($_POST['action']) {
                    ...
                    case 'UsunKategorie':
                        ...
                        $zarzadzajKategoriami->UsunKategorie($id);
                        break;
                    case 'EdytujKategorie':
                        $id = isset($_POST['id']) ? $_POST['id'] : 0;
                        $nazwa = isset($_POST['nazwa']) ? $_POST['nazwa'] : '';
                        $zarzadzajKategoriami->EdytujKategorie($id, $nazwa);
                        break;
                }
            }
        }
        ...
        <body>
            ...
            <form method="post" action="">
                ...
                <select name="matka">
                    ...
                    <?php
                        $zarzadzajKategoriami->PokazOpcjeKategorii(0, 0);
                    ?>
                </select>
